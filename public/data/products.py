...
# Clear existing data
lines.append("DELETE FROM bens_bikes_products;")
...
lines.append("SELECT id, title, image, images FROM bens_bikes_products;")

with open("products.sql", "w", encoding="utf-8") as f:
    f.write("\n".join(lines))

print("✅ products.sql generated with JSON image arrays")
